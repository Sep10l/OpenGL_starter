...
int main()
{
    ...
    // ------------------------------------
    Shader lightingShader("res/shaders/colors.vert", "res/shaders/lightingShader.frag");
    Shader lightCubeShader("res/shaders/lightcubeShader.vert", "res/shaders/lightSource.frag");
